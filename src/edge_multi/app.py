...
from .edge_launcher import launch_profiles
...
class ProfileRow(ctk.CTkFrame):
    """A single profile row: checkbox + name + open/rename/delete buttons."""

    def __init__(self, master, profile: Profile, on_launch, on_delete, on_rename):
        ...
        self.launch_btn = ctk.CTkButton(
            self, text="Open", width=64, corner_radius=RADIUS,
            fg_color=COLOR_PRIMARY, hover_color=COLOR_PRIMARY_HOVER,
        ...
        self.rename_btn = ctk.CTkButton(
            self, text="Rename", width=72, corner_radius=RADIUS,
        ...
        self.delete_btn = ctk.CTkButton(
            self, text="Delete", width=64, corner_radius=RADIUS,
...
class App(ctk.CTk):
    ...
    def _build_header(self) -> None:
        ...
        self.open_folder_btn = ctk.CTkButton(
            actions, text="Open folder", width=110, corner_radius=RADIUS,
        ...
        self.settings_btn = ctk.CTkButton(
            actions, text="Settings", width=90, corner_radius=RADIUS,
            fg_color=COLOR_SURFACE_2, hover_color=COLOR_PRIMARY,
    ...
    def _build_toolbar(self) -> None:
        ...
        self.new_name.grid(row=0, column=0, sticky="w", padx=(0, PAD_SM), ipady=4)
        self.new_name.bind("<Return>", lambda _e: self.add_profile())

        add_btn = ctk.CTkButton(
            bar, text="+ Add profile", width=130, corner_radius=RADIUS,
            fg_color=COLOR_PRIMARY, hover_color=COLOR_PRIMARY_HOVER,
        ...
        self.select_all_btn = ctk.CTkButton(
            bar, text="Select all", width=110, corner_radius=RADIUS,
            fg_color=COLOR_SURFACE_2, hover_color=COLOR_PRIMARY,
        ...
        self.launch_sel_btn = ctk.CTkButton(
            bar, text="Open selected", width=120, corner_radius=RADIUS,
        ...
        self.launch_all_btn = ctk.CTkButton(
            bar, text="Open all", width=110, corner_radius=RADIUS,
            fg_color=COLOR_PRIMARY, hover_color=COLOR_PRIMARY_HOVER,
    ...
    def delete_profile(self, profile: Profile) -> None:
        confirm = messagebox.askyesno(
            ...
            "All browsing data (cookies, logins) of this profile will be removed.",
        )
        if not confirm:
            return
        self.manager.delete(profile.id, remove_data=True)
        self.refresh_list()
    ...
    def _launch(self, profiles: list[Profile]) -> None:
        ...
        def worker() -> None:
            results = launch_profiles(edge_path, profiles, start_url, delay)
...
class SettingsDialog(ctk.CTkToplevel):
    """Settings dialog: Edge path, start URL, launch delay."""
    ...
    def __init__(self, master, settings: dict, on_save):
        ...
        ctk.CTkLabel(self, text="Start URL (optional)", text_color=COLOR_TEXT).grid(
            row=2, column=0, sticky="w", padx=PAD_LG, pady=(PAD_MD, PAD_XS)
        )
        self.url_entry = ctk.CTkEntry(
            self, corner_radius=RADIUS, fg_color=COLOR_SURFACE,
            placeholder_text="https://...",
        )
        self.url_entry.insert(0, settings.get("start_url", ""))
        self.url_entry.grid(row=3, column=0, columnspan=3, sticky="ew", padx=PAD_LG)
        ...
        btns.grid(row=6, column=0, columnspan=3, sticky="e", padx=PAD_LG, pady=PAD_LG)
        ctk.CTkButton(
    ...
    def _save(self) -> None:
        try:
            ...
            messagebox.showwarning("Settings", "Delay must be an integer.")
            return
        new_settings = {
